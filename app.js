...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "https://mathist.pythonanywhere.com/classify_image";
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ['Ajith', 'kajal','lionel_messi', 'maria_sharapova', 'nayandthara', 'roger_federer', 'sai_pallavi', 'serena_williams', 'simbu', 'Sivakarthikeyan', 'vijay', 'vikram', 'virat_kohli']
